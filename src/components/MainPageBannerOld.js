...
//         <div ref={ref} className={`banner-left fade-in-from-left-section ${inView ? "is-visible" : ""}`}>
//           <h1>
...
//           </Link>
//         </div>
//         <div ref={ref} className={`banner-right fade-in-from-right-section ${inView ? "is-visible" : ""}`}>
//           <div
